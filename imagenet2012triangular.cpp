...
Picture* OpenCVPicture::distort(RNG& rng, batchType type) {
  ...
  if (type==TRAINBATCH)
    pic->loadData(224+rng.randint(64));
  else
    pic->loadData(256);
  float
...
(int dimension, ActivationFunction fn,
 int nInputFeatures, int nClasses, int cudaDevice, int nTop)
  ...
  addLeNetLayerMP( 64,7,2,3,2,fn);
  addLeNetLayerMP(256,2,1,3,2,fn);
  addLeNetLayerMP(384,2,1,1,1,fn);
  addLeNetLayerMP(384,2,1,1,1,fn);
  addLeNetLayerMP(384,2,1,3,2,fn);
  addLeNetLayerMP(512,2,1,1,1,fn);
  addLeNetLayerMP(512,2,1,1,1,fn);
  addLeNetLayerMP(512,2,1,3,2,fn);
  addLeNetLayerMP(512,2,1,1,1,fn);
  addLeNetLayerMP(512,2,1,1,1,fn);
  addLeNetLayerMP(512,2,1,1,1,fn);
  addTerminalPoolingLayer(16);
