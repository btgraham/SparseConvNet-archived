...
public:
  ...
  OnlineHandwritingPicture(int renderSize, OnlineHandwritingEncoding enc, int label, float penSpeed3d=0.02);
  ~OnlineHandwritingPicture();
  void normalize();  //Fit centrally in the square [-renderSize/2,renderSize/2]^2
