...
public:
  CNN(int dimension, int nInputFeatures, int nClasses, int pciBusID) : SparseConvNet(dimension, nInputFeatures, nClasses, pciBusID) {
...
int main() {
  ...
  SpatiallySparseDataset trainSet2=Cifar10TrainSet();trainSet2.type=TESTBATCH; //For calculating the top hidden layer for the training set (without dropout or data augmentation)
  SpatiallySparseDataset testSet=Cifar10TestSet(); //For calculating the top hidden layer for the test set
